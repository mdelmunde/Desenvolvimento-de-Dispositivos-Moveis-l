...
import br.com.fatecararas.persistenciadedados.Adaptador.SQLiteAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTextPalavra = findViewById(R.id.textInputPalavras);
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(MainActivity.this, "Records deleted = " + mDB.apagarRegistro(id),Toast.LENGTH_SHORT).show();exibirDadosEmLista();
                return true;
            }
        });
